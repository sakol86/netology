...
В полной виртуализации, гостевая ОС не знает о своём виртуальном окружении и взаимодействует с гипервизором посредством эмуляции аппаратных ресурсов. В паравиртуализации, гостевая ОС осознает своё виртуальное окружение и может напрямую взаимодействовать с гипервизором через специальный интерфейс. В паравиртуализации обычно достигается более высокая производительность, так как гостевая ОС может более эффективно использовать ресурсы физического сервера.
